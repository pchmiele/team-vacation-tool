defmodule TeamVacationTool.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import TeamVacationTool.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&TeamVacationTool.ErrorHelpers.translate_error/1)
