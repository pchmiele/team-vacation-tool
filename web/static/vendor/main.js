...
var _id3as$elm_spa_template$Tabs_Puppies$update = F2(
	function (action, model) {
		var _p0 = A2(_elm_lang$core$Debug$log, 'Action', action);
		return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
	});
var _id3as$elm_spa_template$Tabs_Puppies$model = {url: 'http://ghk.h-cdn.co/assets/16/09/1600x800/landscape-1457107485-gettyimages-512366437.jpg', mdl: _debois$elm_mdl$Material$model};
var _id3as$elm_spa_template$Tabs_Puppies$Model = F2(
	function (a, b) {
		return {url: a, mdl: b};
	});
var _id3as$elm_spa_template$Tabs_Puppies$Bark = {ctor: 'Bark'};
var _id3as$elm_spa_template$Tabs_Puppies$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$src('http://ghk.h-cdn.co/assets/16/09/1600x800/landscape-1457107485-gettyimages-512366437.jpg'),
						_elm_lang$html$Html_Events$onClick(_id3as$elm_spa_template$Tabs_Puppies$Bark)
					]),
				_elm_lang$core$Native_List.fromArray(
					[]))
			]));
};
var _id3as$elm_spa_template$Tabs_Puppies$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: {ctor: '_Tuple2', _0: _id3as$elm_spa_template$Tabs_Puppies$model, _1: _elm_lang$core$Platform_Cmd$none},
			view: _id3as$elm_spa_template$Tabs_Puppies$view,
			subscriptions: _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none),
			update: _id3as$elm_spa_template$Tabs_Puppies$update
		})
};

var _id3as$elm_spa_template$Tabs_Tables$reverse = F2(
	function (x, y) {
...
var _id3as$elm_spa_template$Tabs_Tables$model = {
	url: 'http://ghk.h-cdn.co/assets/16/09/1600x800/landscape-1457107485-gettyimages-512366437.jpg',
	order: _elm_lang$core$Maybe$Just(_debois$elm_mdl$Material_Table$Descending),
	mdl: _debois$elm_mdl$Material$model
};
var _id3as$elm_spa_template$Tabs_Tables$data = _elm_lang$core$Native_List.fromArray(
	[
...
var _id3as$elm_spa_template$Tabs_Tables$rotate = function (order) {
	var _p1 = order;
	if (_p1.ctor === 'Just') {
...
var _id3as$elm_spa_template$Tabs_Tables$update = F2(
	function (msg, model) {
		...
		return {
			...
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{
					order: _id3as$elm_spa_template$Tabs_Tables$rotate(model.order)
				}),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	});
var _id3as$elm_spa_template$Tabs_Tables$Model = F3(
	function (a, b, c) {
		return {url: a, order: b, mdl: c};
	});
var _id3as$elm_spa_template$Tabs_Tables$Item = F3(
	function (a, b, c) {
		return {material: a, quantity: b, unitPrice: c};
	});
var _id3as$elm_spa_template$Tabs_Tables$Data = F3(
	function (a, b, c) {
		return {material: a, quantity: b, unitPrice: c};
	});
...
var _id3as$elm_spa_template$Tabs_Logon$formCss = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'width', _1: '380px'},
			{ctor: '_Tuple2', _0: 'margin', _1: '4em auto'},
			{ctor: '_Tuple2', _0: 'padding', _1: '3em 2em 2em 2em'},
			{ctor: '_Tuple2', _0: 'background', _1: '#fafafa'},
		...
		switch (_p0.ctor) {
			...
			case 'PostSucceed':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{authFailed: false, authorized: true}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'PostFail':
				return A2(
...
var _id3as$elm_spa_template$Tabs_Logon$MDL = function (a) {
	return {ctor: 'MDL', _0: a};
};
var _id3as$elm_spa_template$Tabs_Logon$UsernameChange = function (a) {
	return {ctor: 'UsernameChange', _0: a};
};
var _id3as$elm_spa_template$Tabs_Logon$PasswordChange = function (a) {
...
var _id3as$elm_spa_template$Tabs_Logon$renderFormIfNotLogged = F3(
	function (isRedirect, targetTabName, model) {
		return _elm_lang$core$Basics$not(model.authorized) ? A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_id3as$elm_spa_template$Tabs_Logon$formCss,
					_elm_lang$html$Html_Events$onSubmit(_id3as$elm_spa_template$Tabs_Logon$CheckCredentials)
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('Access denied, invalid credentials'),
									A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_id3as$elm_spa_template$Tabs_Logon$MDL,
							_elm_lang$core$Native_List.fromArray(
								[0]),
							model.mdl,
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_debois$elm_mdl$Material_Textfield$onInput(_id3as$elm_spa_template$Tabs_Logon$UsernameChange),
						...
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_debois$elm_mdl$Material_Textfield$floatingLabel,
									_debois$elm_mdl$Material_Textfield$onInput(_id3as$elm_spa_template$Tabs_Logon$PasswordChange),
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									{ctor: '_Tuple2', _0: 'text-align', _1: 'center'},
									{ctor: '_Tuple2', _0: 'margin-top', _1: '4em'}
								]))
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											{ctor: '_Tuple2', _0: 'font-weight', _1: '300'},
											{ctor: '_Tuple2', _0: 'color', _1: '#636363'}
										]))
								]),
							_elm_lang$core$Native_List.fromArray(
								[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											{ctor: '_Tuple2', _0: 'font-weight', _1: '300'},
											{ctor: '_Tuple2', _0: 'color', _1: '#4a89dc'}
										]))
								]),
							_elm_lang$core$Native_List.fromArray(
								[
...
var _id3as$elm_spa_template$Tabs_Monitoring$white = _debois$elm_mdl$Material_Color$text(_debois$elm_mdl$Material_Color$white);
var _id3as$elm_spa_template$Tabs_Monitoring$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
							...
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[_id3as$elm_spa_template$Tabs_Monitoring$white]),
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text('Nodes')
											]))
									])),
								A2(
											...
											[
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														_elm_lang$core$Native_List.fromArray(
															[
																_elm_lang$html$Html$text('node1')
															]))
													])),
												A2(
												_debois$elm_mdl$Material_Card$text,
											...
											[
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														_elm_lang$core$Native_List.fromArray(
															[
																_elm_lang$html$Html$text('node2')
															]))
													])),
												A2(
												_debois$elm_mdl$Material_Card$text,
...
var _id3as$elm_spa_template$Tabs_Monitoring$update = F2(
	function (msg, model) {
		return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
	});
var _id3as$elm_spa_template$Tabs_Monitoring$model = {mdl: _debois$elm_mdl$Material$model};
var _id3as$elm_spa_template$Tabs_Monitoring$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: {ctor: '_Tuple2', _0: _id3as$elm_spa_template$Tabs_Monitoring$model, _1: _elm_lang$core$Platform_Cmd$none},
			view: _id3as$elm_spa_template$Tabs_Monitoring$view,
			subscriptions: _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none),
			update: _id3as$elm_spa_template$Tabs_Monitoring$update
		})
};
var _id3as$elm_spa_template$Tabs_Monitoring$Model = function (a) {
	return {mdl: a};
};
var _id3as$elm_spa_template$Tabs_Monitoring$Placeholder = {ctor: 'Placeholder'};

var _id3as$elm_spa_template$Register$RegisterResponse = F2(
	function (a, b) {
		return {id: a, email: b};
	});
var _id3as$elm_spa_template$Register$none = A2(_id3as$elm_spa_template$Register$RegisterResponse, '', '');

var _id3as$elm_spa_template$Tabs_Register$formCss = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'width', _1: '380px'},
			{ctor: '_Tuple2', _0: 'margin', _1: '4em auto'},
...
var _id3as$elm_spa_template$Tabs_Register$decodeRegisterResponse = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'email',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		'id',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_id3as$elm_spa_template$Register$RegisterResponse)));
var _id3as$elm_spa_template$Tabs_Register$encodeRegisterRequest = F2(
	function (email, password) {
		return A2(
			_elm_lang$core$Json_Encode$encode,
			0,
...
var _id3as$elm_spa_template$Tabs_Register$model = {email: '', password: '', authFailed: false, authorized: false, mdl: _debois$elm_mdl$Material$model};
var _id3as$elm_spa_template$Tabs_Register$httpCheckCredentials$ = F2(
	function (username, password) {
		return A2(
			_evancz$elm_http$Http$fromJson,
			_id3as$elm_spa_template$Tabs_Register$decodeRegisterResponse,
			A2(
				_evancz$elm_http$Http$send,
				_evancz$elm_http$Http$defaultSettings,
				{
					...
					body: _evancz$elm_http$Http$string(
						A2(_id3as$elm_spa_template$Tabs_Register$encodeRegisterRequest, username, password))
				}));
	});
var _id3as$elm_spa_template$Tabs_Register$Model = F5(
	function (a, b, c, d, e) {
		return {email: a, password: b, authFailed: c, authorized: d, mdl: e};
	});
var _id3as$elm_spa_template$Tabs_Register$LoggedOut = {ctor: 'LoggedOut'};
var _id3as$elm_spa_template$Tabs_Register$RegisterFailed = function (a) {
	return {ctor: 'RegisterFailed', _0: a};
};
var _id3as$elm_spa_template$Tabs_Register$RegisterSucceed = function (a) {
	return {ctor: 'RegisterSucceed', _0: a};
};
var _id3as$elm_spa_template$Tabs_Register$checkCredentials = F2(
	function (username, password) {
		var registerTask = A2(_id3as$elm_spa_template$Tabs_Register$httpCheckCredentials$, username, password);
		return A3(_elm_lang$core$Task$perform, _id3as$elm_spa_template$Tabs_Register$RegisterFailed, _id3as$elm_spa_template$Tabs_Register$RegisterSucceed, registerTask);
	});
var _id3as$elm_spa_template$Tabs_Register$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'CheckCredentials':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_id3as$elm_spa_template$Tabs_Register$checkCredentials, model.email, model.password)
				};
			case 'PasswordChange':
				return {
					ctor: '_Tuple2',
...
var _id3as$elm_spa_template$Tabs_Register$MDL = function (a) {
	return {ctor: 'MDL', _0: a};
};
var _id3as$elm_spa_template$Tabs_Register$EmailChange = function (a) {
	return {ctor: 'EmailChange', _0: a};
};
var _id3as$elm_spa_template$Tabs_Register$PasswordChange = function (a) {
	return {ctor: 'PasswordChange', _0: a};
};
var _id3as$elm_spa_template$Tabs_Register$CheckCredentials = {ctor: 'CheckCredentials'};
var _id3as$elm_spa_template$Tabs_Register$renderForm = F3(
	function (isRedirect, targetTabName, model) {
		return A2(
			_elm_lang$html$Html$form,
			_elm_lang$core$Native_List.fromArray(
				[
					_id3as$elm_spa_template$Tabs_Register$formCss,
					_elm_lang$html$Html_Events$onSubmit(_id3as$elm_spa_template$Tabs_Register$CheckCredentials)
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							A4(
							_debois$elm_mdl$Material_Textfield$render,
							_id3as$elm_spa_template$Tabs_Register$MDL,
							_elm_lang$core$Native_List.fromArray(
								[0]),
							model.mdl,
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_debois$elm_mdl$Material_Textfield$floatingLabel,
									_debois$elm_mdl$Material_Textfield$autofocus,
									_debois$elm_mdl$Material_Textfield$value(model.email),
									_debois$elm_mdl$Material_Textfield$onInput(_id3as$elm_spa_template$Tabs_Register$EmailChange),
									_debois$elm_mdl$Material_Textfield$text$
								]))
						])),
					A2(
						...
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_debois$elm_mdl$Material_Textfield$label('Password'),
									_debois$elm_mdl$Material_Textfield$floatingLabel,
									_debois$elm_mdl$Material_Textfield$onInput(_id3as$elm_spa_template$Tabs_Register$PasswordChange),
									_debois$elm_mdl$Material_Textfield$password
								]))
						])),
					A2(
...
var _id3as$elm_spa_template$Tabs_Register$view = F3(
	function (isRedirect, targetTabName, model) {
		return A2(
			_debois$elm_mdl$Material_Options$div,
			_elm_lang$core$Native_List.fromArray(
...
var _id3as$elm_spa_template$Tabs_Register$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: {ctor: '_Tuple2', _0: _id3as$elm_spa_template$Tabs_Register$model, _1: _elm_lang$core$Platform_Cmd$none},
			view: A2(_id3as$elm_spa_template$Tabs_Register$view, false, ''),
			subscriptions: _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none),
			update: _id3as$elm_spa_template$Tabs_Register$update
		})
};

var _id3as$elm_spa_template$Utils$indexOf$ = F3(
	function (elem, list, index) {
		indexOf$:
		while (true) {
			var _p0 = list;
			if (_p0.ctor === '[]') {
...
var _id3as$elm_spa_template$Utils$indexOf = F2(
	function (elem, list) {
		return A3(_id3as$elm_spa_template$Utils$indexOf$, elem, list, 0);
	});
var _id3as$elm_spa_template$Utils$msg2cmd = function (msg) {
	return A3(
		_elm_lang$core$Task$perform,
		_elm_lang$core$Basics$identity,
		_elm_lang$core$Basics$identity,
...
var _id3as$elm_spa_template$Utils$modelNoMdl = function (model) {
	var mdlStr = _elm_lang$core$Basics$toString(model.mdl);
	var modelStr = _elm_lang$core$Basics$toString(model);
	return A2(
		_elm_lang$core$String$join,
		'...',
		A2(_elm_lang$core$String$split, mdlStr, modelStr));
};
var _id3as$elm_spa_template$Utils$debugDumpModel = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Debug dump of model')
					])),
				_elm_lang$html$Html$text(
				_id3as$elm_spa_template$Utils$modelNoMdl(model))
			]));
};

var _id3as$elm_spa_template$Main$e404 = function (_p0) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
...
var _id3as$elm_spa_template$Main$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
...
var _id3as$elm_spa_template$Main$Tab = F2(
	function (a, b) {
		return {info: a, tabViewMap: b};
	});
var _id3as$elm_spa_template$Main$LogoutMsg = {ctor: 'LogoutMsg'};
var _id3as$elm_spa_template$Main$SelectTab = function (a) {
...
var _id3as$elm_spa_template$Main$RegisterMsg = function (a) {
	return {ctor: 'RegisterMsg', _0: a};
};
var _id3as$elm_spa_template$Main$registerTabViewMap = function (model) {
	var desiredTabInfo = A2(
		_elm_lang$core$Maybe$withDefault,
		_id3as$elm_spa_template$Main$registerTabInfo,
		A2(_elm_lang$core$Array$get, model.desiredTab, model.tabInfoArray));
	var viewWithInjectedArgs = A2(
		_id3as$elm_spa_template$Tabs_Register$view,
		!_elm_lang$core$Native_Utils.eq(model.selectedTab, model.desiredTab),
		desiredTabInfo.tabName);
	return A2(
		_elm_lang$html$Html_App$map,
		_id3as$elm_spa_template$Main$RegisterMsg,
		viewWithInjectedArgs(
			function (_) {
				return _.tabRegister;
			}(model)));
};
var _id3as$elm_spa_template$Main$LogonMsg = function (a) {
	return {ctor: 'LogonMsg', _0: a};
};
var _id3as$elm_spa_template$Main$logonTabViewMap = function (model) {
	var desiredTabInfo = A2(
		_elm_lang$core$Maybe$withDefault,
		_id3as$elm_spa_template$Main$logonTabInfo,
		A2(_elm_lang$core$Array$get, model.desiredTab, model.tabInfoArray));
...
var _id3as$elm_spa_template$Main$MonitoringMsg = function (a) {
	return {ctor: 'MonitoringMsg', _0: a};
};
var _id3as$elm_spa_template$Main$TablesMsg = function (a) {
	return {ctor: 'TablesMsg', _0: a};
};
var _id3as$elm_spa_template$Main$tableTabViewMap = function (model) {
	return A2(
		_elm_lang$html$Html_App$map,
	...
	function (msg, model) {
		...
		switch (_p5.ctor) {
			...
			case 'LogonMsg':
				...
				var _p8 = A2(_id3as$elm_spa_template$Tabs_Logon$update, _p9, ourModel.tabLogon);
				var newChildModel = _p8._0;
				var newChildCommand = _p8._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						ourModel,
						{tabLogon: newChildModel}),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(_elm_lang$core$Platform_Cmd$map, _id3as$elm_spa_template$Main$LogonMsg, newChildCommand),
							ourCommand
						]));
			case 'RegisterMsg':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{tabRegister: newChildModel}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _id3as$elm_spa_template$Main$RegisterMsg, newChildCommand)
				};
			case 'LogoutMsg':
				var _p11 = A2(_id3as$elm_spa_template$Tabs_Logon$update, _id3as$elm_spa_template$Tabs_Logon$LoggedOut, _id3as$elm_spa_template$Tabs_Logon$model);
				var newChildModel = _p11._0;
				var newChildCommand = _p11._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
			...
			case 'TablesMsg':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{tabTables: newChildModel}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _id3as$elm_spa_template$Main$TablesMsg, newChildCommand)
				};
			case 'PuppiesMsg':
				return A6(
					...
					F2(
						function (m, childModel) {
							return _elm_lang$core$Native_Utils.update(
								m,
								{tabPuppies: childModel});
						}),
			...
			default:
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{tabMonitoring: newChildModel}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _id3as$elm_spa_template$Main$MonitoringMsg, newChildCommand)
				};
		}
	});
...
var _id3as$elm_spa_template$Main$tabUrls = _elm_lang$core$Array$fromList(
	A2(
		...
		_id3as$elm_spa_template$Main$tabInfos));
var _id3as$elm_spa_template$Main$urlOf = function (model) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'#',
		A2(
			_elm_lang$core$Maybe$withDefault,
			'',
			A2(_elm_lang$core$Array$get, model.selectedTab, _id3as$elm_spa_template$Main$tabUrls)));
};
var _id3as$elm_spa_template$Main$delta2url = F2(
...
var _id3as$elm_spa_template$Main$urlTabs = _elm_lang$core$Dict$fromList(
	A2(
		...
		_id3as$elm_spa_template$Main$tabInfos));
var _id3as$elm_spa_template$Main$location2messages = function (location) {
	return _elm_lang$core$Native_List.fromArray(
		[
			function () {
...
var _id3as$elm_spa_template$Main$tabViews = _elm_lang$core$Array$fromList(
	A2(
		_elm_lang$core$List$map,
		function (_) {
			return _.tabViewMap;
		...
		_id3as$elm_spa_template$Main$tabList));
var _id3as$elm_spa_template$Main$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _id3as$elm_spa_template$Main$addLogoutButtonIfLogged = function (model) {
	return _id3as$elm_spa_template$Main$isAuthenticated(model) ? A5(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_debois$elm_mdl$Material_Button$onClick(_id3as$elm_spa_template$Main$LogoutMsg)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
...
var _id3as$elm_spa_template$Main$header = function (model) {
	return _elm_lang$core$Native_List.fromArray(
		[
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Elm MDL/SPA Exploration')
						])),
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(
							_id3as$elm_spa_template$Main$getLoggedMsg(model)),
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[])),
							_id3as$elm_spa_template$Main$addLogoutButtonIfLogged(model)
						]))
				]))
		]);
};
var _id3as$elm_spa_template$Main$view = function (model) {
	...
	var currentTab = A2(
		...
		A2(_elm_lang$core$Array$get, model.selectedTab, _id3as$elm_spa_template$Main$tabViews))(model);
	return A3(
		...
		A4(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_debois$elm_mdl$Material_Layout$onSelectTab(_id3as$elm_spa_template$Main$SelectTab)
				]),
			{
				header: _id3as$elm_spa_template$Main$header(model),
...
var _id3as$elm_spa_template$Main$main = {
	main: _rgrempel$elm_route_url$RouteUrl$program(
		{
			delta2url: _id3as$elm_spa_template$Main$delta2url,
			location2messages: _id3as$elm_spa_template$Main$location2messages,
			init: {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					_id3as$elm_spa_template$Main$model,
					{
						mdl: A2(_debois$elm_mdl$Material_Layout$setTabsWidth, 2124, _id3as$elm_spa_template$Main$model.mdl)
					}),
				_1: _debois$elm_mdl$Material$init(_id3as$elm_spa_template$Main$Mdl)
			},
			view: _id3as$elm_spa_template$Main$view,
			subscriptions: function (model) {
				return _elm_lang$core$Platform_Sub$none;
			},
			update: _id3as$elm_spa_template$Main$update
		})
};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _id3as$elm_spa_template$Main$main === 'undefined' ? null : _id3as$elm_spa_template$Main$main);
