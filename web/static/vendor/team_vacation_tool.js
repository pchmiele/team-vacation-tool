...
var _user$project$TeamVacationTool$main = {
	main: _elm_lang$html$Html$text('Hello from Elm')
};

var Elm = {};
Elm['TeamVacationTool'] = Elm['TeamVacationTool'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['TeamVacationTool'], 'TeamVacationTool', typeof _user$project$TeamVacationTool$main === 'undefined' ? null : _user$project$TeamVacationTool$main);
